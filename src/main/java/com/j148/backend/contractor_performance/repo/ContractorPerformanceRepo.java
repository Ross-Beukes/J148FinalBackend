 ...
 * This interface provides methods to retrieve and filter contractor performance data,
 * including details about warnings, attendance, and hearings.
 */
public interface ContractorPerformanceRepo {
     ...
     * @return an Optional containing the contractor performance data if available, 
     *         or an empty Optional if no data is found for the provided user.
    ...
    /**
     * Filters the list of contractor performance data based on the provided filters.
     * The filters are applied to various fields such as attendance, warnings, and contractor status.
     * 
     * @param filters a comma-separated string containing filter conditions (e.g., "attendance-time-in=2022-01-01").
     * @param cp a list of contractor performance records to be filtered.
     * @return a filtered list of contractor performance records that match the specified filter conditions.
     * @throws SQLException if a database access error occurs while filtering the data.
     */
     ...
     * This method fetches basic information about all contractors, including their status and related user details.
     *
     * @return a list of contractor performance records, which contain information about contractors and their users.
     * @throws SQLException if a database access error occurs while fetching the data.
     */
